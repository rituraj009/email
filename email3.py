...
class OutlookLib:
    ...
    def move_to_folder(self, msg, folder_name):
        try:
            folder = msg.Parent.Folders[folder_name]
        except:
            folder = msg.Parent.Folders.Add(folder_name)
        msg.Move(folder)
...
def parse_and_classify_emails(num_emails):
    ...
    for message in messages:
        ...
        try:
            email_info = {
                ...
                'message': message  # Include the original message object for moving
            }
    ...
    for index, email in enumerate(emails, 1):
        ...
        outlook.move_to_folder(email['message'], folder_name)
